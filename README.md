...
| ------ | ------ | --------- | ----------- |
| 🟠 | Агент@Mail.ru версии 1.5 (сборка 00117) | Windows | Работает через hosts, но иногда может отключаться на окне отправки сообщения или после отправки сообщения. |
